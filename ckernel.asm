...
?_002:  cmp     dword [ebp-5CH], 1                      ; 050E _ 83. 7D, A4, 01
        jle near      ?_001                                   ; 0512 _ 0f 8e, fffffe66
...
?_004:  sub     esp, 12                                 ; 05E1 _ 83. EC, 0C
        ...
        je near       ?_006                                   ; 05f3 _ 0f 84, 00000189
        ...
        jle near      ?_012                                   ; 0662 _ 0f 8e, 000002cc
...
?_005:  mov     eax, dword [ebp-28H]                    ; 0674 _ 8B. 45, D8
        ...
        je near       ?_012                                   ; 0681 _ 0f 84, 000002ad
        cmp     dword [ebp-64H], 143                    ; 0687 _ 81. 7D, 9C, 0000008F
        jg  near      ?_012                                   ; 068e _ 0f 8f, 000002a0
...
?_007:  sub     esp, 12                                 ; 07BA _ 83. EC, 0C
        ...
        je near       ?_012                                   ; 07cc _ 0f 84, 00000162
        ...
        jle near      ?_012                                   ; 082f _ 0f 8e, 000000ff
        cmp     dword [ebp-50H], 0                      ; 0835 _ 83. 7D, B0, 00
        jne near      ?_012                                   ; 0839 _ 0f 85, 000000f5
...
?_014:  sub     esp, 12                                 ; 09F8 _ 83. EC, 0C
        ...
        jne near      ?_015                                   ; 0a13 _ 0f 85, 000000a6
...
?_038:  cmp     dword [ebp-4H], 15                      ; 117E _ 83. 7D, FC, 0F
        jle near      ?_029                                   ; 1182 _ 0f 8e, fffffe8a
        leave                                           ; 1188 _ C9
        ret                                             ; 1189 _ C3
...
?_057:  cmp     dword [ebp-8H], 1                       ; 1424 _ 83. 7D, F8, 01
        jle near      ?_058                                   ; 1428 _ 7e, 06
        cmp     dword [ebp+8H], 0                       ; 142A _ 83. 7D, 08, 00
        jnz near      ?_054                                   ; 142e _ 75, b2
...
mouse_decode:; Function begin
        ...
        jnz near      ?_063                                   ; 1529 _ 75, 17
        cmp     byte [ebp-4H], -6                       ; 152B _ 80. 7D, FC, FA
        jnz near      ?_062                                   ; 152f _ 75, 07
...
?_066:  mov     eax, dword [ebp+8H]                     ; 159B _ 8B. 45, 08
        ...
        jne near      ?_069                                   ; 15a4 _ 0f 85, 000000a2
...
?_088:  mov     eax, dword [ebp+8H]                     ; 1E01 _ 8B. 45, 08
        ...
        jg  near      ?_086                                   ; 1e09 _ 7f, df
?_089:  cmp     dword [ebp-0CH], 0                      ; 1E0B _ 83. 7D, F4, 00
        jle near      ?_091                                   ; 1e0f _ 0f 8e, 000000ba
        ...
        jne near      ?_091                                   ; 1e39 _ 0f 85, 00000090
...
?_092:  mov     eax, dword [ebp+8H]                     ; 1F2B _ 8B. 45, 08
        ...
        jg  near      ?_096                                   ; 1f35 _ 0f 8f, 00000087
...
?_108:  mov     eax, dword [ebp+0CH]                    ; 21EB _ 8B. 45, 0C
        ...
        jle near      ?_115                                   ; 21fa _ 0f 8e, 000001d5
        cmp     dword [ebp+10H], 0                      ; 2200 _ 83. 7D, 10, 00
        js near       ?_111                                   ; 2204 _ 0f 88, 000000e2
...
?_115:  mov     eax, dword [ebp-0CH]                    ; 23D5 _ 8B. 45, F4
        ...
        jge near      ?_122                                   ; 23db _ 0f 8d, 00000149
        cmp     dword [ebp-0CH], 0                      ; 23E1 _ 83. 7D, F4, 00
        js near       ?_118                                   ; 23e5 _ 78, 56
...
sheet_slide:; Function begin
        ...
        js near       ?_124                                   ; 25d7 _ 0f 88, 000000d3
...
?_133:  mov     eax, dword [ebp-10H]                    ; 280D _ 8B. 45, F0
        ...
        jg  near      ?_131                                   ; 2816 _ 0f 8f, ffffff51
...
?_150:  mov     eax, dword [ebp+8H]                     ; 29DD _ 8B. 45, 08
        ...
        jge near      ?_140                                   ; 29e6 _ 0f 8d, fffffeb1
        nop                                             ; 29EC _ 90
        leave                                           ; 29ED _ C9
        ret                                             ; 29EE _ C3
...
?_157:  mov     eax, dword [ebp-0CH]                    ; 2B3E _ 8B. 45, F4
        ...
        jne near      ?_158                                   ; 2b4f _ 0f 85, 0000008b
...
?_160:  cmp     dword [ebp-0CH], 499                    ; 2BEF _ 81. 7D, F4, 000001F3
        jle near      ?_157                                   ; 2bf6 _ 0f 8e, ffffff42
        nop                                             ; 2BFC _ 90
        leave                                           ; 2BFD _ C9
        ret                                             ; 2BFE _ C3
...
?_172:  mov     edx, dword [taskctl]                    ; 2F40 _ 8B. 15, 00002308(d)
        ...
        jne near      ?_173                                   ; 2f56 _ 0f 85, 000000c2
...
?_174:  cmp     dword [ebp-8H], 4                       ; 3022 _ 83. 7D, F8, 04
        jle near      ?_172                                   ; 3026 _ 0f 8e, ffffff14
...
task_sleep:; Function begin
        ...
        jne near      ?_188                                   ; 3118 _ 0f 85, 000000ed

ckernel : ckernel_u.asm 
	cp ckernel_u.asm win_sheet.h win_sheet.c mem_util.h mem_util.c write_vga_desktop.c timer.c timer.h global_define.h global_define.c  makefile '/media/psf/Home/Documents/操作系统/文档/19/OS-kernel-win-sheet/'
...
ckernel.o : write_vga_desktop.o win_sheet.o mem_util.o timer.o global_define.o
	ld -m elf_i386 -r write_vga_desktop.o mem_util.o win_sheet.o timer.o global_define.o -o ckernel.o
